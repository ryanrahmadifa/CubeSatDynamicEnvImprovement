...
sample_sizes = [35, 350, 350*2, 350*3, 350*4, 350*5, 350*6, 350*7, 350*8, 350*9, 3500]
results = []
final_model = None
final_X_train = None  # For plotting feature names later
...
for n_samples in sample_sizes:
    ...
    # Save last model for feature importances
    final_model = model
...
# 8. Plot feature importances from final model
if final_model and final_X_train is not None:
